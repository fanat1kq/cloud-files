...
import ru.example.cloudfiles.exception.storageOperation.bucket.BucketCreationException;
import ru.example.cloudfiles.exception.storageOperation.bucket.BucketDeletionException;
...
import ru.example.cloudfiles.exception.storageOperation.resource.ResourceExistenceCheckException;
import ru.example.cloudfiles.exception.storageOperation.resource.ResourceListingException;
import ru.example.cloudfiles.exception.storageOperation.resource.ResourceNotFoundException;
import ru.example.cloudfiles.exception.storageOperation.resource.ResourceRetrievalException;
